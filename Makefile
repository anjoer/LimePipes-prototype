...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fr. Jun 24 06:17:31 2011
...
SOURCES       = main.cpp \
		...
		melodysymbol.cpp \
		melodynote.cpp \
		embellishment.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		pipetune.o \
		musicbar.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/limepipes1.0.0/ && $(COPY_FILE) --parents mainwindow.h pipetune.h musicbar.h symbol.h controlsymbol.h melodysymbol.h melodynote.h embellishment.h itemtypes.h .tmp/limepipes1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp pipetune.cpp musicbar.cpp symbol.cpp controlsymbol.cpp melodysymbol.cpp melodynote.cpp embellishment.cpp .tmp/limepipes1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/limepipes1.0.0/ && (cd `dirname .tmp/limepipes1.0.0` && $(TAR) limepipes1.0.0.tar limepipes1.0.0 && $(COMPRESS) limepipes1.0.0.tar) && $(MOVE) `dirname .tmp/limepipes1.0.0`/limepipes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/limepipes1.0.0
