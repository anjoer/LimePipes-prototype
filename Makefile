...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mi. Jul 13 10:40:59 2011
...
SOURCES       = main.cpp \
		...
		embellishment.cpp \
		pitch.cpp \
		ghbpitch.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		pipetune.o \
		musicbar.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/limepipes1.0.0/ && $(COPY_FILE) --parents mainwindow.h pipetune.h musicbar.h symbol.h controlsymbol.h melodysymbol.h melodynote.h embellishment.h itemtypes.h pitch.h ghbpitch.h .tmp/limepipes1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp pipetune.cpp musicbar.cpp symbol.cpp controlsymbol.cpp melodysymbol.cpp melodynote.cpp embellishment.cpp pitch.cpp ghbpitch.cpp .tmp/limepipes1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/limepipes1.0.0/ && (cd `dirname .tmp/limepipes1.0.0` && $(TAR) limepipes1.0.0.tar limepipes1.0.0 && $(COMPRESS) limepipes1.0.0.tar) && $(MOVE) `dirname .tmp/limepipes1.0.0`/limepipes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/limepipes1.0.0
...
ghbpitch.o: ghbpitch.cpp ghbpitch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ghbpitch.o ghbpitch.cpp
