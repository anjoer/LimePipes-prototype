...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mi. Jul 27 21:06:30 2011
...
SOURCES       = main.cpp \
		...
		pitchlist.cpp \
		ghbpitchlist.cpp \
		notelength.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		pipetune.o \
		musicbar.o \
